---
slug: sport/running_profile
title: Running — Profilo atleta e piano allenamento
kind: profile
category: Sport
module: personal
...
| **PB attuale** | ~1h58:00 |
| **Target** | **1h50:00** |
| **Miglioramento** | ~8 minuti (~23 sec/km più veloce) |

---

## Zone di ritmo di riferimento
...
| **Polpaccio destro** | Episodi passati + sovraccarico **31/05/2026** (ultimo km del progressivo 16 km). Rientro graduale. Risolto in 1-2 giorni (affaticamento muscolare, non lesione). |

---

## Preferenze e vincoli

- **Slot preferito lungo**: sabato mattina
- **Sessioni settimanali**: 3–4
- **Priorità assoluta**: continuità senza infortuni — sostenibilità > performance
- **Non recuperare** i carichi saltati: adattare in modo prudente
- **Sempre warmup + cooldown** negli allenamenti strutturati
- Aumento volume max **10%/settimana**
- Obiettivi secondari: asciugare addome, migliorare continuità
...
| 🔴 **Specifico gara** | 13–16 | Set–Ott | Ripetute a ritmo gara (5:13/km), lunghi con strappi |
...
| ID | Nome | Struttura |
|---|---|---|
| 1572525578 | Lungo easy puro · 15 km · ~1h35 | 2 km warmup + 11 km Z2 (6:00–6:15/km) + 2 km cooldown |
| 1582129354 | Easy aerobico · 8 km · ~50 min | — |
| 1582130735 | Lungo progressivo leggero · 16 km · ~1h40 | — |
| 1589049985 | Soglia controllata 4×5' | — |
| 1576735168 | Soglia controllata 3×6' · 10 km · ~60 min | — |
